# Version parallélisée suivant les blocs (avec Sendrecv)
"""
    Membres du groupe:
    ------------------
...
class Grille2D:
    ...
    def exchange_ghost(self):
        ...
        # Échanges avec les 4 coins diagonaux =====
    ...
    def compute_next_iteration(self):
        ny = self.ny_loc
        nx = self.nx_loc
        N = ny + 2  # taille réelle du tableau en lignes
        M = nx + 2  # taille réelle du tableau en colonnes
...
if __name__ == '__main__':
    ...
    while mustContinue:
        ...
        # Reduce avec MAX vers rank 0, en excluant rank 0 si t_calc=0
