import matplotlib
matplotlib.use('Agg')  # Évite les conflits graphiques
import os
import glob
import numpy as np
...
def main():
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig('comparaison_temps_moyens.png', dpi=150)

    print("\nGraphique sauvegardé sous 'comparaison_temps_moyens.png'.")
